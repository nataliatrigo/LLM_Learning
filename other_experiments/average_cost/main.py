...
root. It writes data and plots under other_experiments/average_cost/outputs by default.
...
def write_diagnostic_report(
    ...
    lines = [
        ...
        "",
        "This report summarizes the extended diagnostics generated by `other_experiments/average_cost/main.py --run-robustness`.",
        "",
        "## Main Outputs",
        "",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--outputs-dir",
        default=None,
        help="Defaults to other_experiments/average_cost/outputs next to this script.",
    )
